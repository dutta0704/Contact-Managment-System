...
def inserir():
    if vnome.get()=="" or vfone.get()=="" or vemail1.get()=="" or vemail2.get() == "":
        messagebox.showinfo(title = "ERRO", message = "Enter all the data")
        return
    try:
...
def deletar():
    try:
        ...
        messagebox.showinfo(title = "ERRO", message = "Choose an item to be deleted.")
def pesquisar():
    tv.delete(*tv.get_children())
...
quadroGrid = LabelFrame(app, text = "Contacts")
...
btn_inserir = Button(quadroInserir, text = "Insert", command = inserir)
btn_deletar = Button(quadroInserir, text  = "Delete", command = deletar)
btn_deletar.place(x = 388, y = -5)
btn_inserir.pack(side = "left", padx = 10)
quadroPesquisar = LabelFrame(app, text = "Search Contacts")
quadroPesquisar.pack(fill = "both", expand = "yes", padx= 10, pady = 10)
lbid =Label(quadroPesquisar, text = "Name")
lbid.pack(side = "left")
vnomepesquisar = Entry(quadroPesquisar)
vnomepesquisar.pack(side = "left", padx = 10)
btn_pesquisar = Button(quadroPesquisar, text = "Search", command = pesquisar)
btn_pesquisar.pack(side = "left", padx = 10)
btn_todos = Button(quadroPesquisar, text = "Show All", command = popular)
